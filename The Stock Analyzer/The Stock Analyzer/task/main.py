...
def vantage_api(function):
    with open("/Users/Natali/Documents/work/PycharmProjects/pythonProject1/stock-api.key", "r") as f:
        stock_api = f.readline()
        symbol = 'AAPL'
        api_url = f"https://www.alphavantage.co/query?function={function}&symbol={symbol}&interval=5min&apikey={stock_api}"
