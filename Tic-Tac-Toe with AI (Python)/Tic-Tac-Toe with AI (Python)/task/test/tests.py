...
class TicTacToeTests(StageTest):
    ...
    @dynamic_test(order=1, time_limit=100000)
    ...
    @dynamic_test(order=2, time_limit=100000)
    ...
    @dynamic_test(repeat=100, order=3, time_limit=100000)
    ...
    @dynamic_test(order=4, time_limit=100000)
    ...
    @dynamic_test(repeat=30, order=5, time_limit=100000)
    ...
    @dynamic_test(repeat=10, order=8, time_limit=100000)
    ...
    @dynamic_test(order=9, time_limit=100000)
    ...
    @dynamic_test(repeat=30, order=10, time_limit=100000)
    ...
    @dynamic_test(repeat=5, order=13, time_limit=100000)
